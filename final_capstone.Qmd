...
library(tidyverse)
setwd("/Users/camaleonico__/Desktop/R Files/final_capstone")
```
...
To make sure I understand how variables have been imported, I use the ´skim_without_charts()´ function

```{r}
library(skimr)
skim_without_charts(mh_2016)
```
